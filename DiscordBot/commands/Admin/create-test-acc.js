...
module.exports = {
    commandInfo: {
        ...
        description: "Creates a test account on Phase with all cosmetics.",
        options: [
            {
                name: "username",
    ...
    execute: async (interaction) => {
        ...
        try {
            ...
            let embed = new MessageEmbed()
                ...
                .setTimestamp()
                .setFooter({
                    text: "Phase Backend - Test Account",
            ...
            await interaction.user.send({
                content: `Hello ${interaction.user.username}, here are your test account details for Phase:`,
                embeds: [embed]
            }).catch(() => {
                dmSent = false;
            });
