            ...
            if (pack === "item") {
                ...
                common_core.items[purchaseId] = {
                    ...
                    "attributes": {
                        ...
                        "params": {
                            "userMessage": `Gifted ${itemData.name} from Phase Backend!`
                        },
                ...
                const embed = new MessageEmbed()
                    ...
                    .setColor("GREEN")
                    .setFooter({ text: "Phase Backend", iconURL: "https://cdn.discordapp.com/attachments/1464667023479930962/1491022027551805540/Obq4q2.jpg?ex=69dacb39&is=69d979b9&hm=4ce43a1db54f2860794a7a859b9e55a3f498f6d33938a1ac3dedc3e01e99bcb5" })
                    .setTimestamp();
            ...
            if (pack === "vbucks") {
                ...
                common_core.items[purchaseId] = {
                    ...
                    "attributes": {
                        ...
                        "params": {
                            "userMessage": `Gifted V-Bucks from Phase Team!`
                        },
                        "giftedOn": new Date().toISOString()
                    },
                    "quantity": 1
