    ...
    execute: async (interaction) => {
        ...
        if (cachedDescription && currentTime - lastUpdate < CACHE_DURATION) {
            ...
            const embed = new MessageEmbed()
                ...
                .setFooter({
                    text: `Phase Backend • Next update in approx ${nextUpdateMinutes}m`
                });
        ...
        try {
            ...
            const embed = new MessageEmbed()
                ...
                .setTimestamp()
                .setFooter({
                    text: isRandom ? "Phase Backend • No leaderboard data found" : "Phase Backend • Results refresh every 1 hour"
                });
