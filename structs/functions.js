    ...
    if (memory.build < 5.3) {
      news.forEach((mode) => {
        ...
        contentpages[mode].news.messages[1].image =
          "https://cdn.discordapp.com/attachments/1475147432454131732/1492413330986631289/Titulo_1.png?ex=69db3db9&is=69d9ec39&hm=1113b39a85ae189bfba4609514ffdd152be27e2abcbf6b9a9da6141ce6bfbde2";
      });
    }
  } catch {}
